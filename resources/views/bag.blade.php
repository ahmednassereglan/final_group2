...
@section('script')
  <script>
    ...
    $(document).ready(function(){
      ...
      var i=0;
      for(product of bag){      
          $("#bag_body").append("<tr id='bag_row_"+ i +"'><td>"+product.name+"</td><td>"+product.price+"</td><td>"+qty+"</td><td>"+ product.price * qty +"</td> <td><a class='btn btn-sm btn-danger' onclick='remove("+ i++ +" , "+product.id+")'>remove</a></td></tr>");
          countItems +=qty;
